package com.api.google.service;
...
public class GoogleDriveService {
	/** Application name. */
	private static final String APPLICATION_NAME = "TryGoogle";

	/** Directory to store user credentials for this application. */
	private static final java.io.File DATA_STORE_DIR = new java.io.File(System.getProperty("user.home"),
			".credentials/TryGoogle");
	...
	// createFile.setTitle("Hello");
	// File file = service.files().insert(createFile ).execute();
...
//	 }
	...
	// * @throws IOException
	// */
	// public static File StartApp() throws IOException {
	// Drive service = getDriveService();
	//
	// String title = "Test project";
	// String description = "one_two_three";
	// String parentId = "0AMHoJS2OBV_rUk9PVA";
